...
<script type="text/javascript" src="CompanyRecruitAdd.js" charset="utf-8"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="tabright">职位名称：</td>
		<td><input id="in_job_name" name="in_job_name" class="easyui-validatebox inputbox" 
		data-options="required:true,missingMessage:'请输入职位名称' ,validType:'length[2,30]' , invalidMessage:'职位名称长度为2到10个字符' "/></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tabright">招聘人数：</td>
		<td><input id="in_job_person_num" name="in_job_person_num" class="easyui-numberspinner" value="1" data-options="increment:1,min:1,max:100" required="true"/></td>
	</tr>
	<tr>
		<td class="tabright">性别限制：</td>
		<td><input id="in_sex" name="in_sex" class="easyui-validatebox" editable="false"/></td>
	</tr>
	<tr>
		<td class="tabright">学历要求：</td>
		<td><input id="in_education" name="in_education" class="easyui-validatebox" editable="false"/></td>
	</tr>
	<tr id="selectProfession">
	...
	<tr id="inputProfession" style="display:none;">
		<td class="tabright">招聘专业：</td>
