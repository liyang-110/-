...
/* ===================================================== */
function setData() {	
	var ls_url = cur_path + "/esbServer.do?method=execProc&methodId=poster_orders&in_action=view&in_order_id=" + id +param+ "&date=" + new Date();
	$.ajax({
		url:ls_url, 
		type:"post", 
		dataType:"text", 
...
function edit() {
	...
	var ls_url = cur_path + "/esbServer.do?method=execProc&methodId=poster_orders&in_action=edit&in_order_id=" + id+param+"&date=" + new Date();
	   //处理数据 code:数据修改成功
