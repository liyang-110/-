...
<script type="text/javascript" src="PosterOrdersAdd.js"  charset="utf-8"></script>
<script type="text/javascript">
...
<input type="hidden" name="in_tpl_id" value="<%=id %>" />
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td class="tabright">说明：</td><td>
		<input id="in_remark" name="in_remark" style="width:390px;" value="<%=dep_name%>" maxlength="100" class="easyui-validatebox inputbox" />
		</td>
	</tr>
</table>
...
<script type="text/plain" id="myEditor" name="content" style="width:1000px;height:100%;">
 ...
 <div style="text-align:center;">
		...
		<a href="javascript:windows.close();" class="easyui-linkbutton" name="btn_return" id="btn_return">取消</a>
</div>
</form>
<script type="text/javascript">
    //实例化编辑器
