...
//				if(onErrorClass!="" && showclass == "onError"){jqobj.removeClass().addClass(onErrorClass)};
                if(onShowClass!="" && showclass == "onShow"){jqobj.removeClass(onShowClass).removeClass(onFocusClass).removeClass(onCorrectClass).removeClass(onErrorClass).addClass(onShowClass)};
				if(onFocusClass!="" && showclass == "onFocus"){jqobj.removeClass(onShowClass).removeClass(onFocusClass).removeClass(onCorrectClass).removeClass(onErrorClass).addClass(onFocusClass)};
				if(onCorrectClass!="" && showclass == "onCorrect"){jqobj.removeClass(onShowClass).removeClass(onFocusClass).removeClass(onCorrectClass).removeClass(onErrorClass).addClass(onCorrectClass)};
				if(onErrorClass!="" && showclass == "onError"){jqobj.removeClass(onShowClass).removeClass(onFocusClass).removeClass(onCorrectClass).removeClass(onErrorClass).addClass(onErrorClass)};
			}
		}
	},
