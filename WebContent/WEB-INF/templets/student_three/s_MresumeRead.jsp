				...
				<div class="col-md-8 c_left">
					<div class="l_header">
						<ul>
							...
							<li class="active"><a href="/student/sMessage.do?type=resumeRead">简历被查看</a><span class="l_span">|</span></li>
					...
					<div class="l_bottom">
						<c:forEach var="row" items="${resumeReadList }">
							<div>
							<ul class="l_b_ul">
								<li><a class="comnamea" href="/jobfair/company.do?id=${row.company_id }">${row.company_name }</a>
									<span class="l_b_status">HR已查看了你的简历</span><span class="l_b_time">${row.add_time }</span>
								</li>
							</ul>
							</div>
						</c:forEach>
						<c:if test="${empty resumeReadList}">
							<div style="padding-left:20px;">
								暂无信息！
							</div>
						</c:if>
						<div style="text-align:center;">
							${resumeReadpagenation }
						</div>
					</div>
				</div>
