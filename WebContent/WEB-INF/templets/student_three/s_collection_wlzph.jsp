...
<html>
	<head>
    	...
    	<link href="/static/css/s_collection_wlzph.css" rel="stylesheet" type="text/css" />
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-8 c_left">
					<div class="l_header">
						<ul>
							...
							<li><span class="active" style="padding:0 20px 0 20px;"><a
									href="/student/sCollection.do?type=wl">网络招聘会</a></span><span>|</span></li>
				...
				%>
						<div>
							<ul class="l_b_ul">
								<li style="width:680px;">只有登陆用户才可以查看参会企业列表</li>
							</ul>
						</div>
						<%
	            ...
	            %>
						<div>
							<ul class="l_b_ul">
								...
								<li><a
									href="/jobfair/detail.do?id=<%=row.get("job_fair_id")%>"
									target="_blank" style="background:none;"><%=row.get("job_fair_name")%></a></li>
								<li><a class="jrhc_a"
									href="/netcongress/start.do?id=<%=row.get("job_fair_id")%>"
	    		...
	    		%>
						<div>
							<ul>
								<li style="padding:10px;">您还未收藏网络招聘会！</li>
							</ul>
						</div>
						<% 
					}
