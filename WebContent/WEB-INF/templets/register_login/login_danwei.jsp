			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-xs-8 logo">
					<a href="/"><img src="/static/image/211logo_wechat2.png" width="50%" alt="图片" class=" img-responsive center-block " style="float:left; margin-top:14px; "></a>
						<span style="float:left;">单位登录</span>
				...
				<div class="left">
					<div>
						<div class="switch_login_control">
							<a class="wxdl" href="/member/accountLogin.do?users=student">求职者登录</a>
							<a class="yhdl active" style="margin-left: 0px;" href="/member/accountLogin.do?users=company" >单位登录<img class="lvxain" style="margin-top:-70px;" src="/static/images/lvxian.png" ></a>
						</div>
						<div style="clear:both;"></div>
