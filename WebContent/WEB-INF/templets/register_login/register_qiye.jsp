			...
			<div class="row">
				<div class="col-lg-3 col-md-4 col-xs-8 logo">
					<a href="/"><img src="/static/image/211logo_wechat2.png" width="50%" alt="图片" class=" img-responsive center-block " style="float:left; margin-top:14px; "></a>
						<span style="float:left;">企业注册</span>
				...
				<div class="left">
					<div id="register_form">
						<div class="switch_login_control">
							...
							<a class="wxdl active" href="/member/accountRegister.do?users=company">企业注册<img class="lvxain" style="margin-top:-70px;" src="/static/images/lvxian.png" ></a>
							<a class="wxdl" href="/member/accountRegister.do?users=school">高校注册</a>
						</div>
						<div style="clear:both;"></div>
						
						<form class="register-form" name="addform" id="addform" action="/login.do" method="post" onsubmit="return false;">
						    ...
						    <input type="hidden" value="company" name="users" />
         					...
         					<div class="control-group">
       						...
       						<div class="control-group">
       							<input class="yonghuming" type="password" id="ruser_pass" name="ruser_pass" placeholder="再次输入密码" errorcontent="请输入密码！"/>   
       						</div>
