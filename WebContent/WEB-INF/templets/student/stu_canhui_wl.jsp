  ...
  <div class="zph_daohang">
     <ul class="nav nav-tabs" role="tablist">
	      <li role="presentation" >
	      		<a class="xiaoyuanzph" href="/student/stuCanhui.do?type=xiaoyuan" aria-controls="profile" role="tab">
	      			校园招聘会
	      		</a>
	      </li>
	      <li role="presentation" class="active">
	      		<a class="wangluozph wlzph" href="/student/stuCanhui.do?type=wangluo" aria-controls="profile" role="tab" data-toggle="tab" >
	      			网络招聘会
	      		</a>
	      </li>
		...
		<div class="tab-content">
          <!--近期招聘会开始  -->
            ...
            <div class="zph_nav">
			 	...
			 	<%
					List wlzphList = (List)request.getAttribute("wlzphList") ;
				...
				<%
	  				}else if(wlzphList!=null &&wlzphList.size()>0){
	          	    int i=0;
	            	for(Iterator iter=wlzphList.iterator();iter.hasNext();){
