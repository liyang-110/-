...
<title>个人中心</title>
	...
	<link href="/static/css/stu_center(01myresume).css" rel="stylesheet" type="text/css">
	...
	<script src="/static/js/stu_resume.js" type="text/javascript" charset="utf-8"></script>
	...
	<script type="text/javascript" src="/static/js/progress.js" charset="utf-8"></script>
	<script type="text/javascript">
	$(function(){
...
<div class="main">
    ...
    <div class="main_r">
    	<div style="width:200px;height:130px;text-align:center;">
		<!-- <a class="main_r_down" href="/student/stuPreview.do"><i class="fa fa-download" ></i>下载简历到本地</a> -->
		<p style="padding:15px;">简历完整度${percents }%</p>
    	<script>
    ...
    <div class="pro"></div>
        ...
        <div class="main_r_nav">
        	<dl>
                 <dd><a class="baceinfo" href="#details_info" style="border-top:1px solid #efefef; border-right:4px solid #e03919; background:#efefef;"> <i class="fa fa-bookmark-o"></i>    基本信息<br></a></dd>
                ...
                <!--  <dd><a class="review" href="#details_review"><i class="fa fa-comment-o"></i>    自我评价</a></dd>  -->           
                 <dd><a  class="return" href="/student/stuCenter.do" style="margin-top:20px; border-top:1px solid #efefef; line-height:40px;"><i class="fa fa-undo"></i>返回个人中心</a></dd>
         	</dl>
     	</div>
	</div><!--mian_r  end  -->
	<div class="main_l">
        	...
        	<div class="details_info" id="details_info">     
           		<div id="baseinfo"> 
					...
					<dt>
						...
						<span class="biaoti" id="narmal_info">基本信息</span>
  						<span class="line_r"></span>
 						<span class="bianji"><img src="/static/images/personal_center/bianji.png" width="20" height="20">&nbsp;&nbsp;
 						<a href="javascript:;" id="stu_info_form_btn" onclick="edit_stu_info(true)">[编辑]</a>
            			<a href="javascript:;" id="stu_info_card_btn"  style="display:none;" onclick="edit_stu_info(false)">[取消]</a></span>
					</dt>

					<div class="summary">
						<h2>${student.name}</h2>
						${student.sex}<span class="ver-line">|</span>${student.educations}<span class="ver-line">|</span>
						<% String datetime=new SimpleDateFormat("yyyy").format(Calendar.getInstance().getTime());
							request.setAttribute("datetime", datetime);
						%>
						<c:choose>
						<c:when test="${datetime - student.grad_year le 0}">										
							<c:out value="工作经验：不足1年"/>	
						</c:when>
						<c:otherwise>
							<c:out value="工作经验：${datetime - student.grad_year}年"/>	
						</c:otherwise>
						</c:choose><br></span>到岗时间 : ${student.work_status }</br>户籍 : ${student.home_areas}<span class="ver-line">|</span>现居 : ${student.areas}<br>
						电话 : ${student.contact_tel }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						QQ : ${student.bind_qq}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<!--基本信息编辑-------------------->       	
        		<form id="stu_info_form"  name="stu_info_form" style="display:none;" method="post" action="/member/ajaxForm.do" onsubmit="return false;">
...
<!--教育经历 ------------------------------->
			<div class="details_edu" id="details_edu">
				<div id="educations">
					<dt>
 						<span class="line_l"></span>
 						<span class="biaoti">教育经历</span>
  						<span class="line_r"></span>
  						<span class="bianji"><img src="/static/images/personal_center/tianjia.png" width="20" height="20">&nbsp;&nbsp;
				...
				<!--教育编辑  ------------->
				<form class="stu_edu_form"  style="display:none;" method="post" action="/member/ajaxForm.do?in_r=su&methodId=student_edu&in_student_id=${student.student_id}" onsubmit="return false;">
...
<!--工作经历 ------------------------------->
			<div class="details_work" id="details_work">
				<div id="working_exprience">
 	     			<dt>
 					<span class="line_l" style="width:284px;"></span>
 					<span class="biaoti" style="width:130px;">实习/实训/工作经历</span>
  					<span class="line_r" style="width:224px;"></span>
 					<span class="bianji"><img src="/static/images/personal_center/tianjia.png" width="20" height="20">&nbsp;&nbsp;
				...
				<!--工作经历编辑开始  -->
				<form class="stu_work_form"  style="display:none;" method="post"
			...
			<%-- <div class="details_review" id="details_review">
				<div id="review">
					<dt>
 					...
 					<textarea class="stu_review auto-height" style="border:none;float:left; margin-left:136px;font-size:16px;color:#999;" readonly="readonly" name="in_introduce" cols="80" rows="2">${student.introduce}</textarea>	
 					<div style="clear:both"></div>
 				</div>
 				<!--综合评述编辑  --------------->
 				
        		<form id="stu_review_form" name="stu_review_form" style="display:none;" method="post" action="/member/ajaxForm.do">
         		<input name="methodId" value="ajax_form" type="hidden">
            	<input name="in_buss_id" value="stu_review" type="hidden">
            	<input name="in_r" value="su" type="hidden">
        		<dd><p style="width: 170px;">综合评述</p>
        			<textarea class="miaoshu auto-height " name="in_introduce"  cols="60" rows="4" style="border-radius:5px; border:1px #666666 solid;float:left;margin-left:20px;padding-left:10px;margin-top:23px;"
                        	onkeydown="checkMaxInput(this,500)"  
				            onkeyup="checkMaxInput(this,500)" 
				            onfocus="checkMaxInput(this,500)" 
