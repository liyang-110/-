<%@ page language="java" pageEncoding="UTF-8"%>
    <div class="f_logo">
    	...
    	<div class="container">
            ...
            <div class="row f_sec_2  pull-left">
            	<div>全国站&nbsp;<a id="site_select_btn" href="javascript:;"><small>[切换]</small></a></div>
            </div>
    ...
    <div class="f_nav">
    	<div class="container navbar">
            <div>
              <ul class='nav'>
                <li><a href="<%=request.getContextPath()%>/">全国站首页</a></li>
                <li><a href="<%=request.getContextPath()%>/jobfairQuery.do?job_fair_type=multiple">双选招聘会</a></li>
                <li><a href="<%=request.getContextPath()%>/jobfairQuery.do?job_fair_type=special">专场招聘会</a></li>
                <li><a href="<%=request.getContextPath()%>/jobfairQuery.do?job_fair_type=organises">企业宣讲会</a></li>
               <!--  
