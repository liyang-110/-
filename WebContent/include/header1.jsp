...
if( request.getParameter("area_name") !=null ){
	area_name =(String)request.getParameter("area_name");
	if( "".equals(area_name) ){
		area_name="全国";
	}
}
    ...
    <div class="f_logo">
    	...
    	<div class="container">
        	...
        	<% PicModel picM=new PicModel(); %>
            		...
            		<img src="<%=request.getContextPath()%>/<%=picM.getLogo() %>"  /></a>
            </div>
    	...
    	<div class="container navbar">
            <div>
              <ul class='nav'>
                ...
                <li><a href="<%=request.getContextPath()%>/multiQueryAction.do?method=jobfairSearch&queryType=moreJobfair&savesign=savesign&area_id=<%=request.getParameter("area_id") %>&job_fair_type=special">专场招聘会</a></li>
                <li><a href="<%=request.getContextPath()%>/multiQueryAction.do?method=jobfairSearch&queryType=moreJobfair&savesign=savesign&area_id=<%=request.getParameter("area_id") %>&job_fair_type=organises">企业宣讲会</a></li>
               <!-- 
