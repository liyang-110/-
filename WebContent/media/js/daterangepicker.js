...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="btn applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>' +
					'<button class="btn cancelBtn" style="margin-left:11px">' + this.locale.cancelLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
        ...
        this.container.find('.ranges').on('mouseleave', 'li', $.proxy(this.updateView, this));
         ...
         this.container.find('.ranges').on('click', '.daterangepicker_start_input,.daterangepicker_end_input', $.proxy(this.showCalendars, this));
