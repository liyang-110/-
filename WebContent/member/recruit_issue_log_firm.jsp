...
if( user ==null ){
	...
	String q="?methodId=recruit_account_log&in_r=co&in_type=recruit_issue&in_URLEncoding=UTF-8";
...
<title><%=company_name %> - 职位发布数使用记录</title>
        ...
        <div class="right">
            ...
            <div class="list_a">
            	<div class="daohang" style="width:845px;height:40px;border-bottom:3px solid red;">
        			<a class="active" href="#">职位发布数使用记录</a>
