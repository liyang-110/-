            ...
            <div class="pull_right">
                <div class="biankuang">
                    ...
                    <div class="form" style="margin:20px 0;padding-left:60px;">
                    	<style>
                    		.table {width:665px;}
                    		.table .text_right {white-space:nowrap;width:100px;}
                    	</style>
                    	...
                    	<table class="table">
                           <tbody>
                              <tr>
                                 ...
                                 <td class="text_left" >
                                   <input id="in_title" value="<%=bean.get("g_title") %>" name="in_title" class=" form-control easyui-validatebox" data-options="required:true,missingMessage:'请输入标题' " type="text" placeholder="">
                                 </td>
                              </tr>
                              <tr>
			    ...
			    try{
			    	...
			    	int  g_year = bean.get("g_year")==null?y:Integer.parseInt(bean.get("g_year").toString() );
			    	out.println(
			    		com.zhaopin.Help.getYearsOptinos(2000, y+5,g_year ) 
			    	);
			    }catch(Exception e){
			    }
			     %>
                              ...
                              <tr>
                                 ...
                                 <td class="text_left">
                                 	<input type="text" value="<%=bean.get("g_total") %>" data-options="required:true,missingMessage:'请输入毕业生人数',invalidMessage:'只能输入数字' " name="in_num" id="in_num" class="form-control width easyui-numberbox " placeholder="">
                                 </td>
                              </tr>
                               <tr>
                                 <td colspan="2">
<script type="text/plain" id="editor"  name="content"><%=model.getContent(g_id) %></script>
  <script type="text/javascript">
    //实例化编辑器
