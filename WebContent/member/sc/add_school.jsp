...
{
	var ls_url = "/esbServer.do?method=execProc&methodId=job_fair_03&in_r=sc&&in_school_id="+school_id+"&in_area_id="+area_id+"&in_add_person="+user_code+"&date=" + new Date();
	$("#"+form_id ).form("submit",{
		url:ls_url,
		onSubmit:function(){
...
<input id="in_job_fair_level" name="in_job_fair_level" class="easyui-validatebox" 
	data-options="required:true,missingMessage:'请选择招聘会学历层次' " style="border:none;width:0px;" />           
                                    </div>
                                 </td>
                              </tr>
                              <tr>
