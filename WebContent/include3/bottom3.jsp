<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
		<div class="container" style="height:30px;border-bottom:1px solid #006FFA;">
		</div>
        <div id="bottom_contact">
        		  <div class="container navbar" style="clear: both;text-align:center;">
                                    <ul class="nav" style="margin:0 auto;float:none;width:370px;">
                ...
                <div class="container">
                    ...
                    -->
                             ...
                             <div class="container" style="padding-top:30px;line-height:1.5em;text-align:center;">
