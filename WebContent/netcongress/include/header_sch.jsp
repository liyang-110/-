...
<div class="menu">
	<ul class="nav nav-pills">
       ...
       <li><a href="/netcongress/start.do?id=<%=job_fair_id %>&m=resume" >求职大厅</a></li>
...
<div id="floatDivBoxs">
    ...
    <div class="floatShadow">
		<ul class="floatDqq">
		<% if(user instanceof SchUserBean){ %>
        	<li style="padding-left:0px;"><a href="/member/home.do" target="_blank"><img src="img/huiyuan.png" align="absmiddle">会员中心</a></li>
            <li style="padding-left:0px;"><a href="/member/sc/manage.jsp" target="_blank"><img src="img/jianli.png" align="absmiddle">管理招聘会</a></li>
            
            
        <% }else{ %>
            <li style="padding-left:0px;"><a href="/daqin_manager" target="_blank"><img src="img/jianli.png" align="absmiddle">后台管理</a></li>
        <% } %>    
...
<!--链接地址-->
	<a href="http://wpa.qq.com/msgrd?v=3&uin=2924094057&Site=211校招网&Menu=yes" target="_blank">
<!--图片地址-->
