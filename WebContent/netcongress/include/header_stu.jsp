...
if( !( userI instanceof StudentSessionBean ) ){
	response.sendRedirect("/");
}
StudentSessionBean user = (StudentSessionBean)userI;
%>
<div class="clearfix">
	<div class="clearfix_top">
       ...
       <div class="pull-right">
          <p class="huiyuan">欢迎会员<span><%=user!=null? user.getUserName():"" %></span>
...
<%-- 
       <li class="activ_one"><a href="index.html">招聘大厅</a></li>
       <li><a href="already.html">已投简历</a></li>
       <li><a href="chance.html">面试机会</a></li>
       <li><a href="result.html">面试结果</a></li>
       <li><a href="http://www.211zph.com/" target="_blank">返回主页</a></li>
--%>
    </ul>
</div>
