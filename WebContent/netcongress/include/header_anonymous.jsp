...
<div class="clearfix">
	<div class="clearfix_top">
       ...
       <div class="pull-right">
       	  <p class="huiyuan">
			<a href="javascript:;" onclick="open_login_layer();">[&nbsp;登录&nbsp;</a>
       ...
       <% }else{ %>
       <div class="pull-right">
          <p class="huiyuan">欢迎会员<span><%=userI!=null? userI.getUserId():"" %></span>
...
<div class="menu">
	...
	<% if( ( userI instanceof SchUserBean ) ){ %>
       ...
       <li><a href="javascript:;" onclick="msg_alert('错误信息','<%=errorMap.get("errorMsg") %>','face-sad');" >求职大厅</a></li>
       <li><a href="javascript:;" onclick="msg_alert('错误信息','<%=errorMap.get("errorMsg") %>','face-sad');" >面试结果</a></li>
	   <li><a href="http://www.211zph.com/" target="_blank">返回主页</a></li>

	<% } else if( ( userI instanceof ComUserBean ) ){ %>
       <li class=""><a href="/netcongress/start.do?id=<%=job_fair_id %>" class="on" >招聘大厅</a></li>
       <li><a href="javascript:;" onclick="msg_alert('错误信息','<%=errorMap.get("errorMsg") %>','face-sad');" >收到简历</a></li>
       <li><a href="javascript:;" onclick="msg_alert('错误信息','<%=errorMap.get("errorMsg") %>','face-sad');" >等待面试</a></li>
       <li><a href="javascript:;" onclick="msg_alert('错误信息','<%=errorMap.get("errorMsg") %>','face-sad');" >面试结果</a></li>
	   <li><a href="http://www.211zph.com/" target="_blank">返回主页</a></li>

	<% } else { %>
       <li class=""><a href="/netcongress/start.do?id=<%=job_fair_id %>" class="on" >招聘大厅</a></li>
       <li><a href="javascript:;" onclick="open_login_layer();" >已投简历</a></li>
       <li><a href="javascript:;" onclick="open_login_layer();" >面试机会</a></li>
       <li><a href="javascript:;" onclick="open_login_layer();" >面试结果</a></li>
	   <li><a href="http://www.211zph.com/" target="_blank">返回主页</a></li>
	<% } %>
    </ul>
</div>
...
<div id="floatDivBoxs">
    ...
    <div class="floatShadow">
        <ul class="floatDqq">
            ...
            <li style="padding-left:0px;"><a href="/member/home.do" target="_blank"><img src="img/jianli.png" align="absmiddle">完善简历</a></li>
            <li style="padding-left:0px;"><a href="javascript:;"  onclick="open_agree_layer();"><img src="img/xuzhi.png" align="absmiddle">参会须知</a></li>
           
            <li style="padding-left:0px;"><a href="/netcongress/start.do?id=<%=job_fair_id %>&m=resume"><img src="img/yitou.png" align="absmiddle">已投简历</a></li>
            <li style="padding-left:0px;"><a href="/netcongress/start.do?id=<%=job_fair_id %>&m=interview" ><img src="img/jihui.png" align="absmiddle">面试机会</a></li>
            ...
            <li style="padding-left:0px;">
            	<a href="http://wpa.qq.com/msgrd?v=3&uin=2677727404&Site=211校招网&Menu=yes" target="_blank">
            	<img src="img/qq.png" align="absmiddle">在线客服</a></li>
        </ul>
