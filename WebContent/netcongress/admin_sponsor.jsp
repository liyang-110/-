		...
		<%
       	...
       	<div  class="pull-left cont_pull"  style="margin:18px;width:210px;">
	        ...
	        <div class="text_im" style="text-align:center;height:32px;">
	        	...
	        	<% }else{ %>
	        	<button type="button" class="btn btn-default contact" style="width:72px;padding-left:7px;color:#666;" onclick="IM_contact('<%=easemobUser%>','','<%=row.get("company_name") %>');">一键面试</button>
	        	<% } %>
	        </div>
	        			<%
	                }else{%>
