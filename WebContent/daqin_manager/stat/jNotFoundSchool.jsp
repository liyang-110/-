...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		var querystr="&in_stat=9";
	</script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/js_common.js"  charset="UTF-8"></script>
	<script type="text/javascript" src="NotFoundSchool.js"  charset="UTF-8"></script>
  </head>
  ...
  <body>
	    ...
	    <div id="dlg_school_name"  style="display:none">
	    	<div style="text-align:center; padding:12px;">
	    			学校名称：<input id ="in_school_name" name="in_school_name"  type="text" size="30" />
	    	</div>
