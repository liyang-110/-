...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript">
		...
		var querystr="&in_stat=7";
	</script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/js_common.js"  charset="UTF-8"></script>
	<script type="text/javascript" src="SchoolStudent.js"  charset="UTF-8"></script>
  </head>
  ...
  <body>
		...
		<div class="easyui-layout" style="width: 100%; height: 330px;" data-options="fit:true,border : false">
			<div data-options="region:'north',border : false">
				<div style="padding:10px 0 10px 20px;background-color:#F4F4F4;">	
				...
				<a id="export-btn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-save' ">导出</a>
