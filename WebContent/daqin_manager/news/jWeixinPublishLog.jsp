...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="WeixinPublishLog.js" charset="utf-8"></script>
  	<style>
	.green {color:green;}
	.red {color:red;}
	</style>
  ...
  <body>
		<div class="easyui-layout" style="width: 100%; height: 230px;" data-options="fit:true,border:false">
		  ...
		  <form id="fm" name="fm" method="post">  
		       公司名称：
		        ...
		        发布日期： <input  id="in_publish_date_1" name="in_publish_date_1" class="easyui-datebox" style="width:100px" />
		            -- <input id="in_publish_date_2" name="in_publish_date_2" class="easyui-datebox" style="width:100px" />
		...
		<div id="dlg_inputPublish" style="display:none">
			<div class="easyui-layout" fit="true">
				...
				<input type="hidden" name="in_action" value="update" />
				<input type="hidden" name="in_company_id" value="" />
				<input type="hidden" name="in_log_id" value="" />
				<table>
					<tr>
