...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="SubPointsInfo.js" charset="utf-8"></script>
  </head>
  ...
  <body>
		...
		<div data-options="region:'north',border : false" style="background:#F4F4F4;">
	        ...
	        <form id="fm" name="fm" method="post">
	        	<input type="hidden" name="in_action" value="self" />
	       		记录类型：
	            <input type="text" id="in_type" name="in_type" class="easyui-validatebox"/>
