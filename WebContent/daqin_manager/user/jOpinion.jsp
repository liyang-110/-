...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="Opinion.js" charset="utf-8"></script>
  </head>
		...
		<div data-options="region:'north',border : false" style="background:#F4F4F4;">
	        ...
	        <form id="fm" name="fm" method="post">
	            ...
	            -- <input id="in_add_time_2" name="in_add_time_2" class="easyui-datebox" style="width:100px" />
	       		用户类型：
				<select class="easyui-combobox" name="in_user_type" style="width:100px;">
				...
				反馈类型：
				<select class="easyui-combobox" name="in_opinion_type" style="width:100px;">
					<option value="">请选择：</option>
