  ...
  <body>
		...
		<div data-options="region:'north',border : false" style="background:#F4F4F4;">
	        <div style="padding:10px 0 10px 20px;">
	        	账号：
	        	<input id="in_user_id" name="in_job_fair_name" class="easyui-validatebox"/>
	       姓名：
	            <input id="in_user_name" name="in_job_fair_type" class="easyui-validatebox"/>
	       邮箱：
	            <input id="in_email" name="in_job_fair_type" class="easyui-validatebox"/>
	       注册时间: <input  id="in_job_add_time_1" class="easyui-datebox" style="width:100px" />
