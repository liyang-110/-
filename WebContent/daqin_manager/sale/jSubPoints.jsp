...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="./SubPoints.js" charset="UTF-8"></script>
  </head>
  ...
  <body>
 	...
 	<div id="edit" class="easyui-window" title="分站充点" data-options="modal:true,closed:true" style="width:300px;height:200px;padding:10px 20px 10px 20px;">
		<form id="fm" method="post"  name="fm">
			<input type="hidden" id="in_id" name="in_id"/>
			地区站名称：<input  class="easyui-validatebox" disabled="true" id="in_name" name="in_name"/>
			<br/>
			充值企业点：<input  class="easyui-numberbox" data-options="min:0,precision:0" id="in_company_points" value="0" name="in_company_points" required="true"/>
			<br/>
			充值学校点：<input  class="easyui-numberbox" data-options="min:0,precision:0" id="in_school_points"  value="0"  name="in_school_points" required="true"/>
			<br/>
			<%/* 
			开始：<input  class="easyui-datebox" id="in_begin_date" name="in_begin_date"/>
			<br/>
			*/ %>
			点数有效期：<input  class="easyui-datebox"  id="in_end_date" name="in_end_date"/>
		    <br/>
