...
/* ===================================================== */
function setData() {	
	var ls_url = cur_path + "/esbServer.do?method=execProc&methodId=ad_user_query&r=ad&in_id=" + id + "&in_user_type="+user_type+"&date=" + new Date();
	$.ajax({
		url:ls_url, 
		type:"post", 
		dataType:"text", 
...
/* ===================================================== */
function edit() {
	var ls_url = cur_path + "/esbServer.do?method=execProc&methodId=ad_points_recharge&r=ad&in_id=" + id+"&date=" + new Date();
	   //处理数据 code:数据修改成功
