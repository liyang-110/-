...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="./AreaPointsInfo.js" charset="utf-8"></script>
  </head>
  ...
  <body>
		...
		<div data-options="region:'north',border : false" style="background:#F4F4F4;">
	       ...
	       企业：
	            <input type="text" id="in_company_name" value="" name="in_company_name" class="easyui-validatebox"/>
	       学校：
	            <input type="text" id="in_school_name" value="" name="in_school_name" class="easyui-validatebox"/>
