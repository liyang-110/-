	...
	$('#resultId').datagrid( {
		...
		columns : [ [
		{
			...
			formatter : function(value,row,index){
				if(row.school_id !=null && row.school_id!='sys'){
...
function getUrl() {
	var ls_url ="";
		ls_url = cur_path + "/esbServer.do?method=execProc&methodId=ad_area_points_info_query&in_r=ad&in_type=school&in_role_id="+role_id;
	return ls_url;	
	}
/* =======================================================*/
// 函数作用：加载或刷新数据
