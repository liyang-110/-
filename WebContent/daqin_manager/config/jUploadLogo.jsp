...
<script type="text/javascript" src="UploadLogo.js"></script>
<script type="text/javascript">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td><input name="uploadusername" type="hidden"   id="uploadusername" value="loader"/>
					...
					<input name="uploadfileid" type="hidden"   id="uploadfileid" style="width: 200px;"/><span class="red">尺寸：236×65像素</span></td>
	</tr>
	<tr>
		<td></td>
		<td>
