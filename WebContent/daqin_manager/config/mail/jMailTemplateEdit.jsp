...
String content=""; 
content=cdata.GetFirfield("select to_char(tpl_content) from tbl_mail_template where tpl_id='"+id+"'");
%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td><input id="in_tpl_id" name="in_tpl_id" class="easyui-validatebox readonly" readonly /></td>
	</tr>
	<tr>
