...
<script type="text/javascript" src="BaseCodeAdd.js" charset="utf-8"></script>
<script type="text/javascript">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="10%">类型编码：</td>
		<td width="90%"><input readonly id="in_base_type" name="in_base_type"  value="member_type" class="easyui-validatebox" required="true"/></td>
	</tr>
	<tr>
		<td width="10%">排序：</td>
		<td width="90%"><input id="in_base_no" name="in_base_no" class="easyui-numberbox" value="0" data-options="min:0" required="true" /></td>
	</tr>
	<tr>
		<td width="10%">编码：</td>
		<td width="90%"><input id="in_base_code" name="in_base_code"  value="member_type_?" class="easyui-validatebox" required="true"/></td>
	</tr>
	<tr>
		<td width="10%">名称：</td>
