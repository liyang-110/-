...
var company_nature="";
var area_id="";
var company_person_num="";
var company_registered_capital="";
var company_name ="";
var status ="";
var add_time_1="";
var add_time_2="";
		...
		columns : [ [
		  {
			...
			formatter : function(value,row,index){
				...
				return status+'<a href="'+cur_path+'/company/info.do?id='+row.company_id+'" target="_blank">'+value+'</a>';
				*/
...
function getUrl() {
	var ls_url ="";
		...
		/*
		+"&in_company_nature="+company_nature
		+"&in_company_name="+company_name+"&in_area_id="+area_id+"&in_company_person_num="+company_person_num
		+"&in_company_registered_capital="+company_registered_capital+"&in_status="+status
