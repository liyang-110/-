...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="NewAD.js" charset="UTF-8"></script>
	<style>
	.green {color:green;}
	.red {color:red;}
	</style>
  ...
  <body>
		<div class="easyui-layout" style="width: 100%; height:100px;" data-options="fit:true,border:false">
		<div data-options="region:'north',border : false" style="background:#F4F4F4;">
        <div style="padding:10px 0 0 20px;">
        <form id="fm" name="fm" method="post" style="margin:0;padding:0;">
                         合同ID：
        	<input id="in_owner_id" name="in_owner_id" class="easyui-validatebox" />
                          文本：
        	<input id="in_title" name="in_title" class="easyui-validatebox" />
                        排序：
        	<input id="in_ad_display" class="easyui-numberspinner" name="in_ad_display" />
                        开始日期：
        	<input  id="in_begindate_1" name="in_begindate_1" class="easyui-datebox" style="width:100px" />
     	 -- <input id="in_begindate_2" name="in_begindate_2" class="easyui-datebox" style="width:100px" />
                        截止日期：
        	<input  id="in_enddate_1" name="in_enddate_1" class="easyui-datebox" style="width:100px" />
     -- <input id="in_enddate_2" name="in_enddate_2" class="easyui-datebox" style="width:100px" />
	    ...
	    <%}%>
                        ...
                        位置：<% /*
		<select id="in_ad_type" class="easyui-combobox" name="in_ad_type">
		<option value="">不限</option>
		 < %= AdModel.getAdTypeOptions() % >
		</select> */  %>
