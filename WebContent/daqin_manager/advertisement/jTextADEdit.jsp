...
<script type="text/javascript" src="<%=request.getContextPath()%>/daqin_manager/advertisement/TextADEdit.js"  charset="utf-8"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="tabright">链接文本：</td>
		<td>
		<select class="easyui-combobox" style="width:50px;background:#76746F;" id="in_color"  name="in_color">
