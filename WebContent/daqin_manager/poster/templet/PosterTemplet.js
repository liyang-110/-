...
function getUrl() {
	var ls_url ="";
		ls_url = cur_path + "/esbServer.do?method=execProc&in_r=ad&methodId=poster_templet&in_URLEncoding=UTF-8"+querystr;
	return ls_url;	
}
...
function edit() {
    ...
    if(lo_selected.length!=1){
        ...
        $('#if_deal')[0].src='./jPosterTempletEdit.jsp?id='+ls_id+'&in_pagesize=' + li_pagesize+'&in_pagenum=' + li_pagenum+'&in_currentnum=' +li_currentnum +"&date="+new Date();
