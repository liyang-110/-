			            ...
			            submitHandler: function(form) {
							...
							$.post(url, $(form).serialize(), function(data){
								if(data=="1"){
									...
									window.location.href="/member/home.do"; // cur_path+"/company/main.jsp";
								}else if(data=="88"){
									window.location.href="/member/home.do"; // cur_path+"/school/main.jsp";
								}else if(data=="99"){
									window.location.href="/member/home.do"; // cur_path+"/student";
								}else{
									showErrDialog("登录失败");
								}
							});
