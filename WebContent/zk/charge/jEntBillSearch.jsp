...
<script type="text/javascript" src="./EntBill.js" charset="utf-8"></script>
  </head>
  ...
  <body>
		...
		<div data-options="region:'north',border : false" style="background:#F4F4F4;">
	       ...
	       时间: <input  id="in_add_time_1" name="in_add_time_1" class="easyui-datebox" style="width:100px" />
	            ...
	            <a href="#" id="searchAndreloadData" class="easyui-linkbutton" iconCls="icon-search">查询</a>
	            
	            <a href="#" id="billStat" class="easyui-linkbutton" iconCls="icon-search">佣金统计</a>
