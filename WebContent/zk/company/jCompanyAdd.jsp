...
<input type="hidden" name="in_zk_id" value="<%=user_code %>" />
...
<tbody>
	...
	<tr>
		<th >登录帐号：</th>
		<td><input id="in_user_id" name="in_user_id"  class="easyui-validatebox"  data-options="missingMessage:'请输入字母和数字' ,required:true"/></td>
		<th >登录密码：</th>
