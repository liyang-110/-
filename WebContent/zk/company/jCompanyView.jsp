...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td width="10%">企业性质：</td>
		<td width="90%" id="company_nature"></td>
	</tr>
	<tr>
		<td width="10%">单位人数：</td>
		<td width="90%" id="company_person_num"></td>
	</tr>
	<tr>
		<td width="10%">注册资金：</td>
		<td width="90%" id="company_registered_capital"></td>
	</tr>
	<tr>
		<td width="10%">用户编码：</td>
	...
	<tr>
		<td width="10%">所属行业：</td>
		<td width="90%" id="industry_name"></td>
	</tr>
	<tr>
		<td width="10%">公司地址：</td>
