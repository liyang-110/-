...
function openOrderJob(company_id,job_id ){
	art.dialog.open("/netcongress/frame/personOrder.jsp?job_fair_id=&school_id=&company_id="+company_id+"&job_id="+job_id, 
						{title: '投递简历',
						 height:290,
						 width:320,	
						 fixed:true,
...
function openOrder(job_fair_id,school_id,company_id,company_name){
	...
	art.dialog.open("/netcongress/frame/personOrder.jsp?job_fair_id="+job_fair_id+"&school_id="+school_id+"&company_id="+company_id+"&company_name="+company_name, 
...
function open_login_layer(){
	art.dialog.open("/netcongress/popoverLogin.jsp", 
						{
					     id : 'popoverLogin',
						 title:false,
						 height:360,
