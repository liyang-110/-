...
progress.prototype.init = function(){
    ...
    if(this.showPresent){
    	//边框颜色border
        this.proFont.setAttribute("style","overflow:hidden;text-overflow:ellipsis; white-space:nowrap; *white-space:nowrap; width:100%; height:100%; color:"+this.fontColor+"; text-align:center; line-height:"+this.h+"px; z-index:3; position:absolute; font-size:12px;border:1px solid #02c084;border-radius: 20px;");
