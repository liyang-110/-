				...
				if (re.length > 0 && re[0].returncode == "ok" 
					...
					for(var i=0;i<initdata.length;i++){
						tr='<div class="work-experience">'+
						   ' <span style="text-align:left;">'+initdata[i].begin_date+'--'+initdata[i].end_date+'</span>'+
						   '<span style="margin-left:458px;">'+
						   '<img src="/static/images/personal_center/bianji.png" width="20" height="20">&nbsp;&nbsp;<a href="javascript:;" onclick="Work.edit(\''+initdata[i].work_id+'\');">编辑</a>'+
						   '<img src="/static/images/personal_center/bianji.png" width="20" height="20">&nbsp;&nbsp;<a href="javascript:;" onclick="Work.del(\''+initdata[i].work_id+'\');">删除</a></span><br/>'+
						   initdata[i].company_name+'<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>'+
						   initdata[i].position+'<span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>'+
						   initdata[i].salary+'元/月<br/>'+
						   '工作描述：<dd>'+initdata[i].introduce+'</dd>'+
						   '</div> ';
						$('.work_two').append(tr);
					}
				}
				...
				if (re.length > 0 && re[0].returncode == "ok"
					...
					for(var i=0;i<initdata.length;i++){
						...
						tr='<div class="education-background">'+
							'<span style="text-align:left;">2010/09 -- 2014/06</span><span style="margin-left:310px;">'+
							'<img src="/static/images/personal_center/bianji.png" width="20" height="20">&nbsp;&nbsp;<a href="javascript:;" onclick="Education.edit(\''+initdata[i].edu_id+'\');">编辑</a>'+
							'<img src="/static/images/personal_center/bianji.png" width="20" height="20">&nbsp;&nbsp;<a href="javascript:;" onclick="Education.del(\''+initdata[i].edu_id+'\');">删除</a></span><br/>'+
							initdata[i].school_name+'&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;'+initdata[i].profession+'&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;'+initdata[i].education+'</div>';
						$('.edu_two').append(tr);
					}
				}
			}});
...
function checkMaxInput(obj, maxLen) {  
    ...
    if (obj.value.length > maxLen) { //如果输入的字数超过了限制  
        ...
        strResult = '<p  style="margin:-20px 0 0 100px;" id="' + newid + '" class=\'Max_msg\' ><br/>剩(' + (maxLen - obj.value.length) + ')字</p>'; //计算并显示剩余字数  
    }  
    else {  
        strResult = '<p  style="margin:-20px 0 0 100px;" id="' + newid + '" class=\'Max_msg\' ><br/>剩(' + (maxLen - obj.value.length) + ')字</p>'; //计算并显示剩余字数  
    }  
