...
if( user ==null ){
	...
	String q="?methodId=job_fair_search&in_r=co&in_URLEncoding=UTF-8&in_company_id="+user.getCompanyId()+"&in_job_fair_type=netcongress";
	// &in_last_zero=on
...
<title><%=company_name %> - 网络招聘会</title>
