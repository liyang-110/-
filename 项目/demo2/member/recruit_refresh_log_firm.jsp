...
if( user ==null ){
	...
	String q="?methodId=recruit_account_log&in_r=co&in_type=recruit_refresh&in_URLEncoding=UTF-8";
...
<title><%=company_name %> - 职位刷新数使用记录</title>
        ...
        <div class="right">
            ...
            <div class="list_a">
            	<div class="daohang" style="width:845px;height:40px;border-bottom:3px solid red;">
        			<a class="active" href="#">职位刷新使用记录</a>
               ...
               <table class="datagrid"  width="750" border="0" cellpadding="0" cellspacing="0" class="mag">
                  ...
                  <tr>
                    ...
                    <td class="content">${r.pay }</td>
                    <td>${r.residue }</td>
                    <td class="content">${r.remark }</td>
                  </tr>
                  </c:forEach>
                  </tbody>
                </table>
