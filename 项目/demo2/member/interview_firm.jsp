...
if( user ==null ){
	...
	String q="?methodId=person_interview_query&in_r=co&in_status=2,4&in_URLEncoding=UTF-8";
...
<title><%=company_name %> - 企业面试通知</title>
            ...
            <div class="right_top">
                ...
                <div class="form">
                	<style>
                		...
                		.form tr td a {color:#666;}
                		.form tr td a:hover{text-decoration:underline;}
                		.form .control {color:#666;}
                		.form .control:hover{text-decoration:underline;}
                		.form .control.on .arrow {
                			  border-right: 8px solid #fc9807;
                	...
                	<table width="750" border="0" cellpadding="5" cellspacing="0">
					  ...
					  <c:forEach var="r" items="${data }">
					   <tr>
                        ...
                        <td>
                          <a onclick="open_layer('/company/resumeDetail.do?id=${r.student_id}')" href="javascript:;" target="_blank">	
                        	${r.name }</a>
                        </td>
                        <td>
                          <a title="${r.jjob_name }" href="/company/jobDetail.do?id=${r.jjob_id }" target="_blank">
                        	${r.jjob_name }</a>
                        </td>
                        <td>
                        <a class="control on" href="javascript:;">
                         ${r.status }<i class="arrow"></i>
                        </a> 
                        </td>
					  </tr>
					  ...
					  <div class="box">
					  	<div class="arrow"></div>
					  	<div class="content">${r.remark }</div>
					  </div>
					  </td>
					  </tr>
					  </c:forEach>
