...
<div class="header_main">
	...
	<tr>
		...
		<td class="text_left">
		<input id="in_job_fair_organizer" name="in_job_fair_organizer" class="easyui-validatebox form-control" /></td>
	</tr>           
	<tr>
		<td class="text_right">协办单位：</td>
		<td class="text_left">
		<input id="in_cooperate_organizer" name="in_cooperate_organizer" class="easyui-validatebox form-control" /></td>
	</tr>    
	<tr>
...
<input id="in_job_fair_level" name="in_job_fair_level" class="easyui-validatebox" required="true" style="border:none;width:0px;" />           
                              ...
                              <tr>
								...
								<input type="text"  readonly="readonly" onclick="select_grad_info();" id="in_grad_info" name="in_grad_info" class="form-control easyui-validatebox" data-options="required:true,missingMessage:'请选择毕业生信息' "/>
            ...
            'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols'
                              ...
                              <tr>
                                 ...
                                 <td class="text_left">
                                    ...
                                    <a href="manage.jsp" class="btn btn-default anniu_a">取消</a>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
