...
if( user ==null ){
	...
	String q="?methodId=job_fair_temp&in_pagenum=20&in_URLEncoding=UTF-8&in_job_fair_type=multiple&in_add_person="+user_code;
...
<script type="text/javascript" src="js/issue_school.js" charset="utf-8"></script>
                ...
                <div class="biankuang">
                	<div class="list_alter">
                    	<ul class="list-inline">
                          <li><a href="add_school.jsp"><img src="img/add.png">添加</a></li>
