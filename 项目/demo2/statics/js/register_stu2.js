        ...
        init: function () {       	
	        $('.register-form2').validate({
	            ...
	            submitHandler: function(form) {
	            	$("#reg_two_sumbit").attr("disabled",true);
	            	$("#reg_two_sumbit").attr("value","已经提交，请稍后…");
					$.ajax({
						...
						success : function(data) {
								    		if (data=="66" || data=="88"){
									    		...
									    		$("#reg_two_sumbit").removeAttr("disabled");
									    		if (data=="4"){
									    			alert("此用户名已存在！");
									    		}else if (data=="8"){
									    			alert("验证码错误！");
									    			...
									    			window.location="register_stu3.jsp";
									    		}else{
									    			alert("注册失败");
									    		}
								    		}	
